...
acc = os.popen("cat /var/lib/jenkins/workspace/mlt-job1/accuracy.txt")
acc1 = acc.read()
print(acc1)
acc2 = acc1.rstrip()
print(acc2)
...
if acc3<80:
    x = os.popen("cat /var/lib/jenkins/workspace/mlt-job1/dl.py | grep model.add | wc -l")
    x1 = x.read()
    x2 = x1.rstrip()
    x3 = int(x2)
    print(x3)
    if x3==2:
        ...
        print("MAAF KARDO")
        exit()
    os.system("sed -i '/softmax/ i {}' /var/lib/jenkins/workspace/mlt-job1/dl.py".format(y))
